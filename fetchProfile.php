...
while ($row = mysqli_fetch_array($result)) {
    ...
    $sql = "SELECT firstname,lastname,almamater,city,business_type,business_name, left(business_description,50) as shortDesc, business_description, profilepicture " .
